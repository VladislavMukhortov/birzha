...
class Create extends Model
{
    ...
    public function rules() : array
    {
        return [
            [
                ['deal', 'crop_id', 'currency', 'price', 'quantity', 'basis', 'period',],
                'required',
            ],
            [
            ...
            ['price', 'double', 'min' => 0, 'max' => 2147483647, 'message' => 'Некорректное значение', 'tooBig' => 'Некорректное значение цены', 'tooSmall' => 'Некорректное значение цены'],
